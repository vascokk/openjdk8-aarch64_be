...
class LoadStoreExclusiveOp(InstructionWithModes):
    ...
    def generate(self):
        ...
        for i in range(self.num_registers):
            self.regs.append(GeneralRegister().generate())
        return self
...
subprocess.check_call(["../../binutils/install/bin/aarch64-none-linux-gnu-as",
                       "aarch64ops.s", "-o", "aarch64ops.o"])

print
print "/*",
sys.stdout.flush()
subprocess.check_call(["../../binutils/install/bin/aarch64-none-linux-gnu-objdump", 
                       "-d", "aarch64ops.o"])
print "*/"

subprocess.check_call(["../../binutils/install/bin/aarch64-none-linux-gnu-objcopy",
                       "-O", "binary", "-j", ".text", "aarch64ops.o", "aarch64ops.bin"])
